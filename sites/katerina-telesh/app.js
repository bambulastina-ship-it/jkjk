/* Katerina Telesh — interaction layer.
...
(function () {
  ...
  var FS = [
    ...
    ' float w1=fbm(q*1.5+vec2(t*.030,t*.019));',
    ...
    ' float g=smoothstep(.54,.93,w2)*smoothstep(1.02,.40,uv.y);',
    ' c=mix(c,champ,g*.26);',
    ' c+=champ*.06*smoothstep(1.15,.0,length(uv-vec2(.13,.10)));',
